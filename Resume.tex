...
\usepackage[lmargin=0.5in, rmargin=0.5in, tmargin=0.2in, bmargin=0.2in]{geometry}
...
\begin{center}
    ...
    % \textit{EMail: jc1068@duke.edu}\qquad $|$ 
...
\subheadingtitlevspace
  \begin{itemize}[leftmargin=0in, label={}]
    {\item{
      ...
      % \titleItem{DevOps and Tools}{: Unix, CI/CD, Git, Docker, Hadoop, AWS (Lightsail, EC2, Cloudfront), GNU debugger, REST API, XCode} \\
      % \titleItem{Others}{: }
    }}
  \end{itemize}
\sectionspace
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Aug. 2024 - May 2026} %(Expected graduate 2026 Spring)
      \resumeItemListStart
...
\section{Professional Experience}
  \resumeSubHeadingListStart
    \resumeExpHeading
      ...
      \resumeItemListStart
        % check the relationship between company and the project description. 
